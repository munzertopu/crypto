...
const WalletDetailsPage: React.FC<WalletDetailsPageProps> = () => {
  ...
  const getWalletDetails = (platform: string) => {
    ...
    return (
      walletMap[platform?.toLowerCase() || "coinbase"] || walletMap["coinbase"]
    );
  };
  ...
  const cryptoAssets: CryptoAsset[] = [
    {
      name: "Bitcoin",
      symbol: "BTC",
      balance: "21.004856252",
      marketValue: "1,323,47",
      logo: "/crypto/bitcoin-btc-logo.png",
      color: "#F7931A",
      percentage: 27,
    },
    {
      name: "Ethereum",
      symbol: "ETH",
      balance: "45.123456789",
      marketValue: "1,023,47",
        ...
        <nav className="flex mb-2" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-2">
            <li className="inline-flex items-center">
              <Link
                to="/wallets"
                className="inline-flex items-center text-base font-normal text-gray-400 dark:text-gray-400 dark:hover:text-white"
              >
                Wallets
              </Link>
            </li>
            <li>
              <div className="flex items-center">
                <span className="w-4 h-4 text-sm text-gray-400 dark:text-gray-600">
                  /
                </span>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex space-x-3">
            ...
            >
              ...
              >
                <path
                  d="M10.96 5.93335C13.36 6.14002 14.34 7.37335 14.34 10.0733V10.16C14.34 13.14 13.1467 14.3333 10.1667 14.3333H5.82665C2.84665 14.3333 1.65332 13.14 1.65332 10.16V10.0733C1.65332 7.39335 2.61999 6.16002 4.97999 5.94002"
                  stroke="currentColor"
                ...
                />
                <path
                  d="M10.2333 3.89996L7.99994 1.66663L5.7666 3.89996"
                  stroke="currentColor"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
          ...
          <div className="flex space-x-2 md:hidden">
            {/* <button
                onClick={() => setIsImportHistoryModalOpen(true)}
                className="w-10 h-10 bg-white dark:bg-[#1A1D1E] border border-gray-200 dark:border-gray-700 rounded-full flex items-center justify-center hover:bg-gray-50 dark:hover:bg-[#2F3232] transition-colors"
              >
                <EyeIcon />
              </button> */}
            <SecondaryButton
