...
const LoginPage: React.FC<LoginPageProps> = ({
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row bg-white mx-14 my-6 p-14">
      {/* Left Side - Login Form */}
      <div className="flex-1 flex items-center px-8 sm:px-12 lg:px-16 text-left">
        <div className="w-full max-w-md">
          {/* Header */}
          <div className="text-center mb-4">
            <h1 className="text-2xl font-bold text-[#0E201E] mb-2 text-left">
              Login
            </h1>
            <p className="text-lg text-[#2F3232] text-left">
      ...
      <div className="flex lg:w-1/2 items-center justify-center p-8 relative overflow-hidden">
