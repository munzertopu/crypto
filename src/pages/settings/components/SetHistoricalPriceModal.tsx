            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <DatePicker
                  ...
                  popperPlacement={screenSize.width < 768 ? "top-start" : "bottom-start"}
                  popperClassName="z-[10000] !top-[-150px] md:!top-0"
                  ...
                  customInput={
                    <div className="flex items-center justify-between w-full">
                      ...
                      <span className="flex-1 text-left ml-3">
                        {selectedDate ? selectedDate.toLocaleDateString('en-US', { month: '2-digit', day: '2-digit', year: 'numeric' }) : 'When custom price will be added'}
                      </span>
                    </div>
                  }
                />
