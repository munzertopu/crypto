                ...
                <div className="absolute top-8 right-0 md:-ml-3 mt-1 bg-white rounded-lg shadow-lg p-4 z-50 border border-gray-200 flex flex-col justify-center">
                  ...
                  <div className="px-3 py-2 hover:bg-gray-50 cursor-pointer">
                    <div className="flex items-center mb-1">
                      ...
                      <span className="text-base text-left text-gray-900 dark:text-gray-250 mx-2">
                        Short Term Gain
                      </span>
                    </div>
                    <div className="text-left">
                      <span className="text-lg font-bold text-gray-900 dark:text-gray-250">
                        $200,744
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="px-3 py-2 hover:bg-gray-50 cursor-pointer">
                    <div className="flex items-center mb-1">
                      ...
                      <span className="text-sm text-left text-gray-900 dark:text-gray-250 mx-2">
                        Long Term Gain
                      </span>
                    </div>
                    <div className="text-left">
