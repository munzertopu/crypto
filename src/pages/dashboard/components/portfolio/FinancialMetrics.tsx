...
import { faDollarSign, faCoins, faWallet, faChevronDown, faBolt, faBriefcase } from '@fortawesome/free-solid-svg-icons';
  ...
  <div className="flex flex-col space-y-2">
    <div className="flex items-center space-x-2 sm:space-x-3 mb-2">
      ...
      <div className="flex items-center space-x-1">
        <span className={`text-lg sm:text-xl lg:text-2xl font-medium ${isDarkMode ? "text-[#B6B8BA]" : "text-[#0E201E]"}`}>{title}</span>
        {showDropdown && (
          <button 
          ...
          >
            <FontAwesomeIcon 
              icon={faChevronDown} 
              className={`${isDarkMode ? "text-[#B6B8BA]" : "text-[#0E201E]"} text-xs transition-transform ${isDropdownOpen ? 'rotate-180' : ''}`} 
              aria-hidden="true"
            />
          </button>
        )}
    ...
    <div className="flex items-center space-x-2">
      <span className={`text-2xl sm:text-3xl font-bold ${isDarkMode ? "text-[#B6B8BA]" : "text-[#0E201E]"}`}>{value}</span>
      ...
      <div className="bg-transparent">
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="lg:ml-auto flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8">
            ...
            />
            {/* Vertical Separator */}
            <div className={`hidden lg:block w-px ${isDarkMode ? "bg-[#2F3232]" : "bg-[#E1E3E5]"}`}></div>
                  ...
                  <div className="absolute top-8 right-0 mt-1 bg-white rounded-lg shadow-lg p-4 z-50 border border-gray-200 flex flex-col justify-center">
                    ...
                    <div className="px-3 py-2 hover:bg-gray-50 cursor-pointer">
                      <div className="flex items-center mb-1">
                        ...
                        <span className="text-md text-gray-900 mx-2">Short Term Gain</span>
                      </div>
                      <div className="text-left">
                        <span className="text-lg font-bold text-gray-900">$200,744</span>
                      </div>
                    </div>
                    ...
                    <div className="px-3 py-2 hover:bg-gray-50 cursor-pointer">
                      <div className="flex items-center mb-1">
                        ...
                        <span className="text-sm text-gray-900 mx-2">Long Term Gain</span>
                      </div>
                      <div className="text-left">
                        <span className="text-lg font-bold text-gray-900">$800,000</span>
                      </div>
                    </div>
                  </div>
                )}
