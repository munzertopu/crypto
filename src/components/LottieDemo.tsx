  ...
  return (
    <div className="px-8 mb-6">
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-150 mb-4">Lottie Animations Demo</h3>
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-lg">
          <h4 className="text-sm font-medium text-gray-900 dark:text-gray-150 mb-2">How to Use:</h4>
