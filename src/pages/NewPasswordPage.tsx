...
const NewPasswordPage: React.FC<NewPasswordPageProps> = ({ onBackToLogin, email = 'jon.doe@gmail.com' }) => {
      ...
      <div className="flex-1 flex items-center justify-center px-8 sm:px-12 lg:px-16 text-left">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-4">
            <h1 className="text-3xl font-bold text-gray-900 mb-2 text-left">Set New Password</h1>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  aria-label={showPassword ? 'Hide new password field' : 'Show new password field'}
                >
                  <FontAwesomeIcon 
