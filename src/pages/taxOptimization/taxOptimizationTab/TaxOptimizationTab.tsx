  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-3 md:gap-0">
        ...
        {/* Legend - Right */}
        <div className="flex items-start md:items-center space-x-6 text-sm">
          <div className="flex items-center space-x-2">
              ...
              <thead className={`bg-table-header dark:bg-gray-800`}>
                ...
                <tr role="row">
                  {TABLE_HEAD.map((head, index) => (
                    ...
                    ${
                      head === "Potential Gains"
                        ? "border-l-2 border-green-500"
                        : ""
                    }
                    ${
                      head === "Long term gains"
                        ? "border-l-2 border-[#8C5DF3]"
                        : ""
                    }
                    `}
                    >
                ...
                {cryptoAssets.map((asset, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-left" role="cell">
                      <Typography
                        variant="small"
                        className={`font-normal text-primary dark:text-gray-250`}
                      >
                    ...
                    {/* Potential Gains */}
                    <td
                      className="px-6 border-l-2 border-[#75ae46] py-4 text-left"
                      role="cell"
                    >
                      <Typography
                        variant="small"
                    ...
                    <td className="px-6 py-4 text-left relative" role="cell">
                      <div
                        ...
                        onMouseEnter={() =>
                          asset.shortTerm.longTermTransitionDate &&
                          handleTooltipShow(asset.id)
                        }
                            ...
                            >
                              <div className="relative">
                                ...
                                <div className="text-center">
                                  This asset will become a long-term holding in{" "}
                                  {asset.shortTerm.monthsUntilLongTerm} months (
                                  {asset.shortTerm.longTermTransitionDate})
                                </div>
                              </div>
                            </div>
                    ...
                    {/* Long term gains */}
                    <td
                      className="px-6 py-4 border-l-2 border-[#8C5DF3] text-left"
                      role="cell"
                    >
                      <Typography
                        variant="small"
                    ...
                    <td className="px-6 py-4 text-left relative" role="cell">
                      <div
                        className="relative"
                        onMouseEnter={() =>
                          handleTooltipShow(asset.id + "-shortVsLong")
                        }
                        onMouseLeave={handleTooltipHide}
                      >
                        <ShortVsLongBar
                        ...
                        {tooltipOpen === asset.id + "-shortVsLong" && (
                          ...
                          >
                            <div className="relative">
                              ...
                              <div className="text-center">
                                Short Term Gain:{" "}
                                {asset.shortVsLongPercentage.short}%
                                <br />
                                Long Term Gain:{" "}
                                {asset.shortVsLongPercentage.long}%
                              </div>
                            </div>
                          </div>
                        )}
