...
const AmountRangeDropdown: React.FC<AmountRangeDropdownProps> = ({
  ...
  return (
    <div className="relative">
      ...
      {/* Dropdown Content */}
      {isOpen && (
        <div className={`absolute top-full left-0 mt-1 p-4 rounded-lg border shadow-lg z-50 w-80 ${
          isDarkMode 
           ...
           <div className="flex-1">
             ...
             <div className="relative">
               ...
               {showFromCurrencyDropdown && (
                 <div className={`absolute top-full right-0 mt-1 rounded-lg border shadow-lg z-20 ${
                 ...
                 <div className="py-1">
                   {['USD', 'EUR', 'USDT'].map((currency) => (
                     <button
                       ...
                       className={`w-full px-3 py-1 text-left text-xs ${fromCurrency === currency ? 'bg-blue-50 text-blue-600' : ''}`}
                     >
                       {currency}
                     </button>
                   ))}
                 ...
                 <div className="py-1">
                   {['USD', 'EUR', 'USDT'].map((currency) => (
                     <button
                       ...
                       className={`w-full px-3 py-1 text-left text-xs ${toCurrency === currency ? 'bg-blue-50 text-blue-600' : ''}`}
                     >
                       {currency}
                     </button>
                   ))}
