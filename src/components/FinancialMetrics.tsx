  ...
  <div className="flex flex-col gap-3">
    <div className="flex items-center gap-1.5">
      ...
      <div className="flex items-center md:gap-3">
        <span
          className={`text-base ${isLarge ? "md:text-[18px]" : "md:text-16[px]"} font-medium md:font-semibold text-gray-900 dark:text-[#B6B8BA] opacity-80`}
        >
          {title}
        </span>
        {showDropdown && (
    ...
    >
      <span className={`text-xl ${isLarge ? "md:text-[32px]" : "md:text-24[px]"} font-semibold text-gray-900 dark:text-[#B6B8BA]`}>
        {value}
      </span>
      <span
                ...
                <div className="absolute top-8 right-0 md:-ml-3 mt-1 bg-white rounded-lg shadow-lg p-4 z-50 border border-gray-200 flex flex-col justify-center">
                  ...
                  <div className="px-3 py-2 hover:bg-gray-50 cursor-pointer">
                    <div className="flex items-center mb-1">
                      ...
                      <span className="text-base text-left text-gray-900 mx-2">
                        Short Term Gain
                      </span>
                    </div>
                  ...
                  <div className="px-3 py-2 hover:bg-gray-50 cursor-pointer">
                    <div className="flex items-center mb-1">
                      ...
                      <span className="text-sm text-left text-gray-900 mx-2">
                        Long Term Gain
                      </span>
                    </div>
                    <div className="text-left">
